...
export function SystemAdminLayout() {
  return (
    <SysAdminProvider>
      <div className="relative flex min-h-screen flex-col overflow-hidden bg-gradient-to-b from-blue-950 via-slate-950 to-slate-950 text-white">
        <Navbar />
        ...
        <div className="relative mx-auto flex-1 max-w-7xl px-4 pb-12 pt-28 sm:px-6 lg:px-8">
          <div className="mb-8">
