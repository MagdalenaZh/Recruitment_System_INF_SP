    ...
    public class RecruitmentDataProvider : IRecruitmentDataProvider
    {
        ...
        public async Task<List<ClubDatabaseModel>> GetAllClubsInformationAsync(CancellationToken cancellationToken)
        {
            ...
            while (reader.Read())
            {
                ...
                var admissionQuestions = reader.GetInt32(2);

                var seriaizedQuestionaire = JsonSerializer.Deserialize<List<string>>(admissionQuestions, _serializerOptions);
                ...
                clubs.Add(new ClubDatabaseModel(clubId, clubmentName, seriaizedQuestionaire));
            }
        ...
        public async Task<List<DepartmentDatabaseModel>> GetDepartmentsForClubAsync(Guid clubId, CancellationToken cancellationToken)
        {
            ...
            while (reader.Read())
            {
                ...
                departments.Add(new DepartmentDatabaseModel(departmentId, clubId, departmentName, numberOfOpenPositions));
            }
